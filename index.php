    ...
    <main class="login-wrapper">
        <div class="login-card">
            ...
            <div class="form-section">
                ...
                <form action="actions/auth.php" method="post" id="authForm" class="auth-form">
                    ...
                    <div class="form-footer" style="margin-top: 1.5rem; text-align: center; color: #6b7280; font-size: 0.875rem;">
                        Don't have an account? <a href="signup.php" style="color: #4f46e5; text-decoration: none; font-weight: 500;">Sign up</a>
                    </div>
                </form>
            </div>
